...
define('can/view/stache/mustache_core', [
    ...
    MethodExpression.prototype.helperAndValue = function (scope, helperOptions, readOptions) {
        var looksLikeAHelper = this._args.length || !can.isEmptyObject(this._hash), helper, name, methodKey = this.name.key, initialValue, args;
        if (looksLikeAHelper) {
                    ...
                    return function () {
                        ...
                        if (utils.isArrayLike(value)) {
                            ...
                            if (isObserveList ? value.attr('length') : value.length) {
                                return (stringOnly ? getItemsStringContent : getItemsFragContent)(value, isObserveList, helperOptionArg, helperOptions);
                            } else {
...
define('can/view/bindings/bindings', [
    ...
    var handleEvent = function (el, data) {
        var attributeName = data.attributeName, event = attributeName.indexOf('can-') === 0 ? attributeName.substr('can-'.length) : removeBrackets(attributeName, '(', ')'), handler = function (ev) {
                ...
                var args = attrInfo.args(localScope, null, {}), hash = attrInfo.hash(localScope, null, {});
